...
object Lollipop {
    ...
    fun init() {
        ...
        MainMaterial = Material.getMaterial(cyanPlugin.config.getString("MainMaterial") ?: "DIAMOND_BLOCK") ?: Material.DIAMOND_BLOCK
        ...
        for (i in middleBlock.x .. middleBlock.x + maxRadius * 2) {
            middleBlock.world.getBlockAt(i, middleBlock.y, middleBlock.z).type = Material.QUARTZ_BLOCK
        }
